        ...
        <div class="row align-items-center gx-md-5">
            <div class="col-12 col-xl-4 text-center mb-5 mb-xl-0">
                <div class="img-with-logo">
                    ...
                    <img class="img-with-logo__down not-absolute "
            ...
            <div class="col-12 col-xl-8 mb-5 mb-xl-0">
                <div class="row mx-0 mb-5">
                    <div class="col-12 col-xl-6 ms-md-0 mb-5 mb-xl-0">
                        <img src="<?php echo $img2; ?>" alt="" class="w-100 w-lg-auto">
                    </div>
                    <div class="col-12 col-xl-6 me-md-0 d-flex align-items-center">
                        <div class="text">
                            <?php echo $text_upper ?>
                        </div>
                    </div>
