        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="prices__table-row">
                    <button type="button" class="prices__table-btn specialists__btn" data-tab="<?php echo $counter; ?>"
                        <?php if($counter===0) { echo "style='border-top: 0;'"; } ?>>
                        ...
                        <div class="prices__table-item--row specialists__item--row">
                            <span class="prices__table-item--service specialists__doctor--wrapper">
                                <span class="specialists__doctor">
                                    <?php if ($specs['title']) : ?> <span
                                        class="specialists__doctor--title"><?php echo $specs['title']->name ?></span>
                                    <?php endif; ?>
                            ...
                            <span class="prices__table-item--price specialists__links">
                                ...
                                <a href="#" class="specialists__link specialists__link--visit"
